#!/usr/bin/env perl
# 
# writeAnnotatedTreeFromFile.pl:  Generates annotated SEED and tree files for use as release flatfiles
# .taxtree files are the ones provided as Rfam.seed_tree files on the ftp server
# 
use strict;
