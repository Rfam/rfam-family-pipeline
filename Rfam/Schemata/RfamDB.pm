...
=head2 prepare_nseFamilyToBitscore
  ...
  Incept   : SWB Mon August 18 2014
  Useage   : $rfamdb->prepare_nseFamilyToBitscore
  Function : Returns a DBI statement handle for executing queries. This statement has four bind values: rfam_acc, rfamseq_acc, seq_start, seq_end
  Args     : none
  Returns  : DBI statement handle
